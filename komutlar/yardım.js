...
//YARDIM KOMUTU
  ...
  .setColor('#FFFB05')
  .setDescription(`**Örnek Kullanım:** \`${prefix}yardım \` \n **Örnek:** \`${prefix}aboneyardım\``)
  .addField('Kategoriler:', `
  **[${prefix}aboneyardım](https://discord.gg/2vPdmYz) Abone Menüsünü Açar** 
  **[${prefix}botlistyardım](https://discord.gg/2vPdmYz) Bot List Menüsünü Açar**
  **[${prefix}eğlence](https://discord.gg/2vPdmYz) Eğlence Menüsünü Açar**
  **[${prefix}moderasyon](https://discord.gg/2vPdmYz) Moderasyon Menüsünü Açar**
  `)
  .addField("» Linkler", ` [Davet Et](https://discord.com/api/oauth2/authorize?client_id=820276467057295380&permissions=8&scope=bot)`  + "** | **" + `[Oy Ver](https://bit.ly/3980hK)`  + "** | **" + `[Web Sitesi](https://gnarge.xyz)  `, false)
